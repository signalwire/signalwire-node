...
describe('Messaging', () => {
  ...
  describe('.send()', () => {
    ...
    it('should return a SendResult with success 200 response code', async () => {
    ...
    it('should return a SendResult with failed 400 response code', async () => {
  ...
  describe('.onReceive()', () => {
    ...
    it('should handle the messaging.receive notification', async () => {
  ...
  describe('.onStateChange()', () => {
    ...
    it('should register the state change listener', async () => {
      Connection.mockSend.mockClear()
    ...
    it('should handle the messaging.state notification', async () => {
      const fnMock = jest.fn()
