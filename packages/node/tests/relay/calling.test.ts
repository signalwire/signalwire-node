...
describe('Calling', () => {
  ...
  describe('.dial()', () => {
    ...
    const _dialNotificationAnswered = JSON.parse(`{"event_type":"calling.call.dial","event_channel":"signalwire_channel-id","timestamp":123457.1234,"space_id":"space-id","project_id":"project-id","params":{"dial_state":"answered","tag":"mocked-uuid","node_id":"node-id","call":{"call_id":"call-id","tag":"mocked-uuid","node_id":"node-id","device":{"type":"phone","params":{"from_number":"+1234","to_number":"15678"}},"dial_winner":true}}}`)
    ...
    const _dialNotificationFirstCallAnswered = JSON.parse(`{"event_type":"calling.call.dial","event_channel":"signalwire_channel-id","timestamp":123457.1234,"space_id":"space-id","project_id":"project-id","params":{"dial_state":"answered","tag":"mocked-uuid","node_id":"node-id","call":{"call_id":"call-id-1","node_id":"node-id","tag":"mocked-uuid","device":{"type":"phone","params":{"from_number":"1234","to_number":"5678","timeout":30}},"dial_winner":true}}}`)
    ...
    const _dialNotificationFailed = JSON.parse(`{"event_type":"calling.call.dial","event_channel":"signalwire_channel-id","timestamp":123457.1234,"space_id":"space-id","project_id":"project-id","params":{"dial_state":"failed","tag":"mocked-uuid","node_id":"node-id"}}`)
