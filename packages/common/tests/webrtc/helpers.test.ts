...
describe('Helpers browser functions', () => {
  ...
  describe('mutateCanvasInfoData', () => {
    ...
    it('should transform canvasInfo with overlap', () => {
      const canvasInfo = JSON.parse(`{"canvasID":-1,"totalLayers":2,"layersUsed":2,"layoutFloorID":1,"layoutName":"presenter-floor-small-top-right","canvasLayouts":[{"x":0,"y":0,"scale":360,"hscale":360,"zoom":0,"border":0,"floor":0,"overlap":0,"screenWidth":1280,"screenHeight":720,"xPOS":0,"yPOS":0,"resID":"screen","audioPOS":"0.000000:0.0:1.000000","memberID":1114},{"x":300,"y":0,"scale":60,"hscale":60,"zoom":0,"border":0,"floor":1,"overlap":1,"layerOccupied":true,"screenWidth":213,"screenHeight":120,"xPOS":1066,"yPOS":0,"audioPOS":"0.831250:0.0:0.166667","memberID":1113}],"scale":360}`)
      const result = mutateCanvasInfoData(canvasInfo)
      const expected = JSON.parse(`{"canvasId":-1,"totalLayers":2,"layersUsed":2,"layoutFloorId":1,"layoutName":"presenter-floor-small-top-right","canvasLayouts":[{"startX":"0%","startY":"0%","percentageWidth":"100%","percentageHeight":"100%","x":0,"y":0,"scale":360,"hscale":360,"zoom":0,"border":0,"floor":0,"overlap":0,"screenWidth":1280,"screenHeight":720,"xPos":0,"yPos":0,"resID":"screen","audioPos":"0.000000:0.0:1.000000","participantId":"1114"},{"startX":"83.33%","startY":"0%","percentageWidth":"16.67%","percentageHeight":"16.67%","x":300,"y":0,"scale":60,"hscale":60,"zoom":0,"border":0,"floor":1,"overlap":1,"layerOccupied":true,"screenWidth":213,"screenHeight":120,"xPos":1066,"yPos":0,"audioPos":"0.831250:0.0:0.166667","participantId":"1113"}],"scale":360,"layoutOverlap":true}`)
      expect(result).toStrictEqual(expected)
    })
